...
function ContactPage({ onBookAppointment }: ContactPageProps) {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#111827] text-slate-700 dark:text-slate-200">
      <section className="relative overflow-hidden bg-[#f7f0e5] border-b border-[#E1D8CC] dark:border-slate-800/40">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 lg:py-28">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="text-4xl font-serif font-bold leading-tight text-[#333333] dark:text-[#F8FAFC] sm:text-5xl">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] border border-[#E1D8CC] dark:border-slate-800 bg-white dark:bg-[#111827] p-8 shadow-sm sm:p-10">
            <h2 className="text-2xl font-serif font-semibold text-[#333333] dark:text-[#F8FAFC]">
              Visit our clinic
            </h2>
            ...
            <div className="mt-8 space-y-5">
              <div className="flex items-start gap-3 rounded-2xl border border-stone-200 dark:border-slate-800 bg-slate-50 dark:bg-[#111827] p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Embilipitiya, New Town Road</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-stone-200 dark:border-slate-800 bg-slate-50 dark:bg-[#111827] p-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100">Email</h3>
                  <a href="mailto:prasad@gmail.com" className="mt-1 block text-sm text-slate-600 dark:text-slate-300 transition-colors hover:text-[#C76B3D]">
                    prasad@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-stone-200 dark:border-slate-800 bg-slate-50 dark:bg-[#111827] p-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100">Appointment inquiries</h3>
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Please email us to request a consultation time.</p>
                </div>
              </div>
            </div>
          </div>

          <div className="rounded-[2rem] border border-[#E1D8CC] dark:border-slate-800 bg-[#333333] dark:bg-brand-primary p-8 text-[#f7f0e5] dark:text-[#333333] shadow-sm sm:p-10">
            ...
            <div className="mt-8 space-y-4 rounded-2xl border border-white/10 bg-white dark:bg-[#111827]/5 p-5">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#f7f0e5] dark:text-[#333333] transition-colors hover:text-[#C76B3D]"
              >
                prasad@gmail.com
                <ArrowRight className="h-4 w-4" />
              </a>
